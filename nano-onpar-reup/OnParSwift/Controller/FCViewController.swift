...
//    fileprivate var message : DataSnapshot!
...
//        ref = Database.database().reference() //establishes connection to database
...
//                    let MsgLength = self.remoteConfig["msg_length"]
//                    if MsgLength.source != .static {     //check to see if msg length came from remote config rather than default variable in app
//                        self.msglength = MsgLength.numberValue!
...
//            fetchConfig()  //assign most recent value from configuration
//
//        }
//    }
//
...
//        var mdata = data
//        //adds display name to data so when setting value it include text and who sent it
//        mdata[Constants.MessageFields.name] = displayName
//        //this allows us to store each message as a child to "messages" using a unique identifying string for each message (eg /messages/[some_auto_id]
...
//               // unpack message in selected row from firebase data snapshot
...
//               if let imageUrl = message[Constants.MessageFields.imageUrl] {
//                    //if it already exists in cache show that
//                   if let cachedImage = imageCache.object(forKey: imageUrl as NSString) {
...
//        //if text field not empty message packaged to a data dictionary (Constants.MessageFields.text is the key) and passed to send message function
...
//        NotificationCenter.default.addObserver(self, selector: #selector(FCViewController.keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(FCViewController.keyboardWillHide), name: UIResponder.keyboardWillShowNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(FCViewController.keyboardDidShow), name: UIResponder.keyboardWillShowNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(FCViewController.keyboardDidHide), name: UIResponder.keyboardWillShowNotification, object: nil)
//    }
//
